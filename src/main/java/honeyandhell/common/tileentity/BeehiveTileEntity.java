...
import honeyandhell.init.ModTileEntities;
...
public class BeehiveTileEntity extends LockableLootTileEntity {
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.honeyandhell.beehive", new Object[0]);
    }

    protected Container createMenu(int p_213906_1_, PlayerInventory p_213906_2_) {
        return BeehiveContainer.createGeneric9X3(p_213906_1_, p_213906_2_, this);
    }
