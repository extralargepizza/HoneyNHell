...
public class ModItems
{
    ...
    public static void registerItems(RegistryEvent.Register<Item> event)
    {
        ...
        royal_jelly = registerItem(new SimpleFoiledItem(new Item.Properties().group(ItemGroupHAH.instance)), "royal_jelly");

        bee_larvae = registerItem(new BeeLarvaeItem(new Item.Properties().group(ItemGroupHAH.instance).maxStackSize(1)), "bee_larvae");
        ...
        queen_bee = registerItem(new QueenBeeItem(new Item.Properties().group(ItemGroupHAH.instance).maxStackSize(1).rarity(Rarity.EPIC).maxDamage(16)), "queen_bee");
